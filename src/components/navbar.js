...
function navbar() {
  return (
    <div className="header-container03">
      <div className="header-container04"></div>
      <div className="header-container05">
            ...
            <div data-thq="thq-navbar-nav" className="header-desktop-menu">
              <nav className="header-links">
                <span className="header-text">
                  <Link to="/">Ayodhya</Link>
                </span>
                <span className="header-text01">
                  <Link to="/roadmap">Roadmap</Link>
                </span>
                <span className="header-text02">
                  <Link to="/minting">How to Mint</Link>
                </span>
                <span className="header-text03">FAQs</span>
              </nav>
            </div>
            ...
            <div data-thq="thq-mobile-menu" className="header-mobile-menu">
              <div className="header-nav">
                ...
                <nav className="header-links1">
                  <span className="header-text04">About</span>
                  <span className="header-text05">Features</span>
                  <span className="header-text06">Pricing</span>
                  <span className="header-text07">Team</span>
                  <span className="header-text08">Blog</span>
                </nav>
        ...
        <div className="header-container07">
          <span className="header-text09">Connect Wallet</span>
        </div>
      </div>
    </div>
  );
